...
type ServerState = { type: 'state'; roomId: string; seat: number; players: { seat: number }[]; started: boolean; countdownEndsAt: number | null; startingUntil: number | null; game: Game; scoreSnapshot: number[] };
