...
type Props = { game: Game; setGame: React.Dispatch<React.SetStateAction<Game | null>>; profile: Profile; userId?: string; remoteGameId?: string; room: Room; round: number; roundCount: number; matchScores: number[]; roundScores?: number[]; onUpdateProfile: (patch: Partial<Profile>) => void; onExit: () => void; onHelp: () => void; onReplay: () => void; paused: boolean; playerSeat?: number; onRemoteAction?: (action: string, payload: Record<string, unknown>) => void; onlineRoomId?: string; onlineStarted?: boolean; onlinePlayers?: { seat: number }[]; onlineCountdownEndsAt?: number | null; onlineStartingUntil?: number | null; onlineResultUntil?: number | null };
const W = 1600, H = 900;
